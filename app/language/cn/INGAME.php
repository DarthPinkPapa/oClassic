...
$LNG['type_mission_6']  					= '刺探';
$LNG['type_mission_7']  					= '殖民';
$LNG['type_mission_8']  					= '回收';
$LNG['type_mission_9']  					= '销毁';
...
$LNG['lm_overview']							= '星球概况';
$LNG['lm_galaxy']							= '银河';
$LNG['lm_empire']							= '帝国统计';
$LNG['lm_fleet']							= '舰队调度';
$LNG['lm_buildings']						= '基地建设';
$LNG['lm_research']							= '科研项目';
$LNG['lm_shipshard']						= '舰队生产';
$LNG['lm_defenses']							= '防御设施';
$LNG['lm_resources']						= '资源报表';
$LNG['lm_officiers']						= '雇佣官员';
$LNG['lm_trader']							= '资源转换';
$LNG['lm_fleettrader']						= '星际贸易';
$LNG['lm_technology']						= '科技树';
$LNG['lm_messages']							= '消息';
$LNG['lm_alliance']							= '联盟';
$LNG['lm_buddylist']						= '盟友';
$LNG['lm_notes']							= '笔记';
...
$LNG['ov_of']								= '/';
$LNG['ov_planet']							= '行星';
$LNG['ov_server_time']						= '星际时间';
$LNG['ov_events']							= '动态';//Activities
$LNG['ov_diameter']							= '直径';
...
$LNG['ov_security_confirm']					= '您确定要摧毁掉 %s 这颗行星？';
$LNG['ov_password']							= '密码';
$LNG['ov_delete_planet']					= '遗弃行星';
...
$LNG['fl_departure']						= '抵达(目的地)';
$LNG['fl_destiny']							= '目的地';
$LNG['fl_objective']						= 'Objective';
$LNG['fl_arrival']							= '抵达(返航)';
$LNG['fl_info_detail']						= '详情';
$LNG['fl_order']							= '命令';
$LNG['fl_new_mission_title']				= '新任务：选取舰队';
$LNG['fl_ship_type']						= '飞船类型';
$LNG['fl_ship_available']					= '飞船可用';
...
// Edificios
$LNG['bd_dismantle']						= '拆除';
$LNG['bd_interrupt']						= '中断(Interrupt)';
$LNG['bd_cancel']							= '取消';
$LNG['bd_working']							= '忙碌中';
$LNG['bd_build']							= '建造';
$LNG['bd_build_next_level']					= '升级为Level';//建筑升级，砍掉
$LNG['bd_research']							= '研究';
...
$LNG['bd_next_level']                       = '下一级别：';
$LNG['bd_need_engine']                      = '需要多消耗<font color="#FF0000">%s</font>点%s';
$LNG['bd_more_engine']                      = '增加<font color="#00FF00">%s</font>点发电量';//<input type="hidden">%s</input>
...
$LNG['al_not_exists']						= '该联盟不存在';
$LNG['al_newname_specialchar']				= '联盟的名称和简称只能由字母、数字以及下划线（_）、横杆（-）以及点（.）组成！';
$LNG['al_description_message']		        = '这里描写联盟的对外公告';
$LNG['al_web_text']							= '联盟网站';
$LNG['al_request']					        = '应用';//Aplication可能是application 应用
$LNG['al_click_to_send_request']		    = '向该联盟发送消息';
$LNG['al_tag_required']					    = '没有输入联盟简称';
$LNG['al_name_required']					= '没有输入联盟全称';
$LNG['al_already_exists']					= '联盟“%s”已存在。';
$LNG['al_created']					        = '联盟“%s”建立成功';
$LNG['al_continue']							= '继续';
...
$LNG['al_all_players']						= '全部盟友';
$LNG['al_no_ranks_defined']				    = '没有任何地位职称';
$LNG['al_request_text']						= 'Text of the application';
$LNG['al_inside_text']						= '对内公告';
$LNG['al_outside_text']						= '对外公告';
...
$LNG['al_name']								= '更改联盟全称';
$LNG['al_new_name']							= '更改联盟全称 (3-30 字符)';
$LNG['al_tag']								= '更改联盟简称';
$LNG['al_new_tag']							= '更改联盟简称 (3-8 字符)';
$LNG['al_user_list']						= '盟友列表';
$LNG['al_users_list']                       = '盟友列表 (数量: %d)';
$LNG['al_manage_alliance']					= '管理联盟';
$LNG['al_send_circular_message']			= '发送联盟通告';
$LNG['al_circular_front_text']				= 'The player %s wrote the following:';
$LNG['al_new_requests']						= '%d New orders';
$LNG['al_goto_chat']						= '联盟聊天室';
$LNG['al_save']								= '保存';
$LNG['al_dlte']								= '删除';
$LNG['al_rank_name']						= '名称';
$LNG['al_ok']								= 'OK';
$LNG['al_num']								= 'ID';
$LNG['al_member']							= '名称';//member，Name
$LNG['al_request_from_user']                = 'The requests of players';
$LNG['al_request_register_time']            = '注册时间：';
$LNG['al_request_last_onlinetime']          = 'Last activity';
$LNG['al_message']							= '消息';
$LNG['al_position']							= '地位';
$LNG['al_points']							= '积分';//Points
$LNG['al_coords']							= '坐标';
$LNG['al_member_since']						= '加入时间';
$LNG['al_estate']							= '在线状况';
$LNG['al_back']								= '返回';
$LNG['al_actions']							= 'Actions';
$LNG['al_change_title']						= '更换标题';
$LNG['al_the_alliance']						= 'of Alliance';
$LNG['al_change_submit']					= '应用';
$LNG['al_reply_to_request']				    = '相应该请求';
$LNG['al_reason']							= '原因';
...
$LNG['al_ally_info_tag']					= '简称';
$LNG['al_ally_info_name']					= '全称';
...
$LNG['al_circular_send_ciruclar']			= '发送联盟通告';
$LNG['al_circular_alliance']				= 'Alliance ';
$LNG['al_receiver']							= 'Receiver';
$LNG['al_circular_send_submit']			    = '发送';
$LNG['al_circular_reset']					= '清空';
$LNG['al_alliance']							= '联盟';
$LNG['al_alliance_make']					= '建立一个联盟';
$LNG['al_alliance_search']					= '搜索联盟';
$LNG['al_your_ally']						= '您的联盟';
$LNG['al_rank']								= '地位';
$LNG['al_web_site']							= '联盟主页';//Homepage
$LNG['al_inside_section']					= '内部公告';
$LNG['al_make_alliance']					= '建立联盟';
$LNG['al_make_ally_tag_required']			= '联盟简称 (3-8 字符)';
$LNG['al_make_ally_name_required']			= '联盟全称 (3-30 字符)';
$LNG['al_make_submit']						= '搜索';
$LNG['al_find_alliances']					= '搜索联盟';
$LNG['al_find_text']						= '联盟名称';
$LNG['al_find_no_alliances']                = '没有找到联盟!';
...
$LNG['sh_name']								= '名称';
$LNG['sh_members']							= '成员';
$LNG['sh_points']							= '积分';//Points
$LNG['sh_search_in_the_universe']			= '星际搜索';
$LNG['sh_player_name']						= '玩家名称';
$LNG['sh_planet_name']						= '星球名称';
$LNG['sh_alliance_tag']						= '联盟简称';
$LNG['sh_alliance_name']					= '联盟名称';
$LNG['sh_search']							= '搜索';
$LNG['sh_write_message']					= '发送消息';
$LNG['sh_buddy_request']					= '添加为好友';
$LNG['sh_alliance']							= '联盟';
$LNG['sh_planet']							= '行星';
$LNG['sh_coords']							= '坐标';
$LNG['sh_position']							= '等级';//Rank
$LNG['sh_loading']							= '(搜索中...)';
